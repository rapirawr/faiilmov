...
<div class="min-h-screen flex flex-col items-center justify-center px-4 py-12 relative z-10 overflow-hidden">
    ...
    <div class="w-full max-w-xl glass-panel p-8 sm:p-14 rounded-[2.5rem] border border-white/12 shadow-2xl relative overflow-hidden text-center backdrop-blur-xl">
        ...
        <!-- Top Accent Line -->
        <div class="absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-red-500/60 to-transparent"></div>

        <!-- Animated Glitch Icon -->
        <div class="w-20 h-20 rounded-3xl bg-red-500/10 border border-red-500/25 text-red-400 flex items-center justify-center mx-auto mb-6 shadow-xl shadow-red-500/10 backdrop-blur-md relative group">
            <i data-lucide="zap-off" class="w-10 h-10 animate-pulse"></i>
        </div>
        ...
        <h2 class="text-2xl sm:text-3xl font-bold text-white tracking-tight mb-3 font-sans">
            Sinyal Proyektor Terganggu
        </h2>
        <p class="text-xs sm:text-sm text-zinc-400 leading-relaxed max-w-md mx-auto mb-8">
            Terjadi masalah teknis di server kami. Tim teknis kami telah mendapatkan pemberitahuan dan sedang memperbaiki kendala ini.
        </p>
