...
<div class="min-h-screen flex flex-col items-center justify-center px-4 py-12 relative z-10 overflow-hidden">
    ...
    <div class="absolute -top-32 left-1/2 -translate-x-1/2 w-[600px] h-[350px] bg-purple-600/15 rounded-full blur-[140px] pointer-events-none"></div>
    ...
    <div class="w-full max-w-xl glass-panel p-8 sm:p-14 rounded-[2.5rem] border border-white/12 shadow-2xl relative overflow-hidden text-center backdrop-blur-xl">
        ...
        <div class="w-20 h-20 rounded-3xl bg-purple-500/10 border border-purple-500/25 text-purple-400 flex items-center justify-center mx-auto mb-6 shadow-xl shadow-purple-500/10 backdrop-blur-md">
            <i data-lucide="wrench" class="w-10 h-10 animate-bounce"></i>
        </div>

        <!-- Tag -->
        <div class="mb-3">
            <span class="text-xs font-bold uppercase tracking-widest text-purple-400 px-3.5 py-1 rounded-full bg-purple-500/10 border border-purple-500/20">
                Maintenance Mode
            </span>
        </div>
        ...
        <p class="text-xs sm:text-sm text-zinc-400 leading-relaxed max-w-md mx-auto mb-8">
            Kami sedang melakukan peningkatan performa dan pembaruan server untuk memberikan pengalaman streaming terbaik. Kami akan kembali segera!
        </p>
